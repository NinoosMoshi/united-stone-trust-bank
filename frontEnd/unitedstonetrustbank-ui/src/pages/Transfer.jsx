...
export default function Transfer() {
    ...
    //         const response = await AuditorService.findAccountByAccountNumber(formData.accountNumber);
    ...
    //         const response = await AuditorService.findAccountByAccountNumber(formData.destinationAccountNumber);
    //         const account = response.data || [];
    ...
    const handleSubmit = async (e) => {
        ...
        // Validate form
        // validate if there is no amount or destination account number
        ...
        // validate if amount is less than 0
        ...
        // validate if user is trying to transfer to the same account(to his own account)
        if (formData.accountNumber === formData.destinationAccountNumber) {
            setError('Source and destination accounts cannot be the same');
            setLoading(false);
            return;
        ...
        // Check if source account has sufficient(enough) balance
        ...
        try {
            ...
            const response = await TransactionService.makeTransfer(transferData);
                ...
                <div className="transfer-form-section">
                    ...
                    <form onSubmit={handleSubmit} className="transfer-form">
                        ...
                        <div className="form-group">
                            ...
                            > {verifyingAccount ? 'Verifying...' : 'Verify'}</button> */}
