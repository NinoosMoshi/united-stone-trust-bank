...
export default function AuditorDashboard() {
    ...
    const loadSystemTotals = async () => {
        ...
        try {
            const response = await AuditorService.getSystemTotals();
            if (response.data) {
    ...
    const searchUser = async () => {
        ...
        try {
            const response = await AuditorService.findUserByEmail(userEmail.trim());
            if (response.data) {
    ...
    const searchAccount = async () => {
        ...
        try {
            const response = await AuditorService.findAccountByAccountNumber(accountNumber.trim());
            if (response.data) {
    ...
    const loadAccountTransactions = async (accountNum) => {
        ...
        try {
            const response = await AuditorService.findTransactionsByAccountNumber(accountNum);
            if (response.data) {
    ...
    const searchTransaction = async () => {
        ...
        try {
            const response = await AuditorService.findTransactionById(id);
            if (response.data) {
