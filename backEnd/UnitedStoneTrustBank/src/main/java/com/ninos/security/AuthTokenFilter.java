...
/**
 * Authentication filter that intercepts each request to validate the JWT token.
...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    private String getTokenFromRequest(HttpServletRequest request){
        String tokenWithBearer = request.getHeader("Authorization"); // Bearer dfsdjk34hj34k2j34h23j
